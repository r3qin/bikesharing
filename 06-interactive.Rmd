...
In fact, we found that precipitation has a diminishing marginal effect. Specifically, the change of daily trip counts from 0 (no rain) to 0.1 inches of rain is more significant than that from 0.5 to 0.6 inches. And the correlation between rain and lower ridership is less clear partly because the number of observations is inefficient in our data set.